@script('pages-index', 'page/js/edit.js', 'requirejs')
...
<form id="js-page" class="uk-form uk-form-horizontal" action="@url.route('@page/page/save', ['id' => page.id ?: 0])" method="post">
    ...
    <div class="uk-form-row">
        @trans('Slug'):
        <a class="js-slug" href="#" data-uk-toggle="{target:'.js-slug'}">@(page.slug|length ? page.slug : '...')</a>
    ...
    <div class="uk-form-row">
        <ul class="uk-subnav uk-">
            <li>
                @trans('Status'):
                <a class="uk-text-danger js-status uk-hidden" data-status="0">@trans('Unpublished')</a>
                <a class="uk-text-success js-status uk-hidden" data-status="1">@trans('Published')</a>
