<form id="js-page" class="uk-form uk-form-horizontal" action="@url.to('@page/page/save', ['id' => page.id ?: 0])" method="post">
    ...
    <p>
        ...
        <a class="uk-button" href="@url.to('@page/page/index')">@( page.id ? trans('Close') : trans('Cancel') )</a>
    </p>
