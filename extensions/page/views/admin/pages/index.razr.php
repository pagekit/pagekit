...
<form id="js-pages" class="uk-form" action="@url.to('@page/page/index')" method="post">

    <div class="pk-options uk-clearfix">
        <div class="uk-float-left">

            <a class="uk-button uk-button-primary" href="@url.to('@page/page/add')">@trans('Add Page')</a>

            <div class="uk-button-dropdown" data-uk-dropdown="{ mode: 'click' }">
                <button class="uk-button" type="button">@trans('Actions') <i class="uk-icon-caret-down"></i></button>
                <div class="uk-dropdown uk-dropdown-small">
                    <ul class="uk-nav uk-nav-dropdown">
                        <li><a href="#" data-action="@url.to('@page/page/status', ['status' => 1])">@trans('Enable')</a></li>
                        <li><a href="#" data-action="@url.to('@page/page/status', ['status' => 0])">@trans('Disable')</a></li>
                        <li class="uk-nav-divider"></li>
                        <li><a href="#" data-action="@url.to('@page/page/copy')">@trans('Copy')</a></li>
                        <li><a href="#" data-action="@url.to('@page/page/delete')">@trans('Delete')</a></li>
                    </ul>
                </div>
            </div>
    ...
    <table class="uk-table uk-table-hover uk-table-middle">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="@url.to('@page/page/edit', ['id' => page.id])">@page.title</a>
                </td>
                <td class="uk-text-center">
                    <a href="#" data-action="@url.to('@page/page/status', ['ids[]' => page.id, 'status' => page.status ? '0' : '1'])" title="@page.statusText">
                        <i class="uk-icon-circle uk-text-@(page.status ? 'success' : 'danger')" title="@page.statusText"></i>
                    </a>
                </td>
                <td>
                    <div class="uk-text-truncate"><a href="@url.to('@page/id', ['id' => page.id])" target="_blank">@(url.to('@page/id', ['id' => page.id])|slice(app.router.requestContext.baseUrl|length))</a></div>
                </td>
                <td>
