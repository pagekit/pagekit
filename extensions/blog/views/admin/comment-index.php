...
<div id="comments" class="uk-form" data-uk-observe v-cloak>
    ...
    <div class="uk-overflow-container">
        ...
        <table class="uk-table uk-table-hover pk-table-large">
            ...
            <tbody v-repeat="comment: comments" track-by="id">

                <tr class="check-item" v-if="editComment.id !== comment.id" v-class="uk-active: active(comment)" v-component="row" inline-template>
                ...
                <tr v-if="editComment.id === comment.id">
