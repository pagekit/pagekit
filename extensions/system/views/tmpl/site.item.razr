<div class="uk-nestable-item pk-table-fake">
    ...
    <div class="pk-table-width-minimum"><input ng-model="selections[node.id]" ng-true-value="{{ node }}" type="checkbox"></div>
...
<ul ng-if="children.length" class="uk-nestable-list">
    <li class="uk-nestable-list-item" ng-repeat="node in children" ng-include="'site.item'" ng-init="children = vm.getChildren(node.id)" ng-class="{ 'uk-parent': children.length }"></li>
</ul>
