<form class="uk-article uk-form uk-form-stacked" action="@url.route('@system/auth/authenticate')" method="post">
    ...
    <div class="uk-form-row">
        <label for="form-password" class="uk-form-label">@trans('Password') <a href="@url.route('@system/resetpassword')">@trans('(Forgot Password?)')</a></label>
        <div class="uk-form-controls">
