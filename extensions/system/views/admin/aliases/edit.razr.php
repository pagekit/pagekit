...
<form class="uk-form uk-form-horizontal" action="@url.to('@system/alias/save', ['id' => alias.id ?: 0])" method="post">
    ...
    <p>
        ...
        <a class="uk-button" href="@url.to('@system/alias/index')">@( alias.id ? trans('Close') : trans('Cancel') )</a>
    </p>
