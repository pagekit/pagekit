...
<form class="uk-form uk-form-horizontal" action="@url.to('@system/user/save', ['id' => user.id ?: 0])" method="post">
    ...
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match>
        ...
        <div class="pk-content uk-width-medium-3-4">
            ...
            <p>
                ...
                <a class="uk-button" href="@url.to('@system/user/index')">@( user.id ? trans('Close') : trans('Cancel') )</a>
            </p>
