...
<form id="js-dashboard" class="uk-form" action="@url.to('@system/system/admin')" method="post" data-reorder="@url.to('@system/dashboard/reorder')">
    ...
    <div class="pk-options uk-clearfix">
        <div class="uk-float-left">
            ...
            <div class="uk-button-dropdown" data-uk-dropdown="{ mode: 'click' }">
                ...
                <div class="uk-dropdown uk-dropdown-small">
                    <ul class="uk-nav uk-nav-dropdown">
                        ...
                        <li><a href="@url.to('@system/dashboard/add', ['type' => type.id])">@type.name</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
            ...
            <div class="uk-button-dropdown" data-uk-dropdown="{ mode: 'click' }">
                ...
                <div class="uk-dropdown uk-dropdown-small">
                    <ul class="uk-nav uk-nav-dropdown">
                        <li><a href="#" data-action="@url.to('@system/dashboard/delete')">@trans('Delete')</a></li>
                    </ul>
                </div>
            </div>
    ...
    <ul class="uk-sortable" data-uk-sortable="{ maxDepth: 1 }">
        ...
        <li data-id="@id">
            ...
            <div class="uk-sortable-item pk-table-fake">
                ...
                <div>
                    <a href="@url.to('@system/dashboard/edit', ['id' => id])">@widget.title</a>
                </div>
