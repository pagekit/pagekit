...
<ul class="uk-grid pk-system" data-uk-grid-margin>
    ...
    <li class="uk-width">
        <a class="uk-panel pk-system-hover" href="@url.to('@system/settings/index')">
    ...
    <li class="uk-width">
        <a class="uk-panel pk-system-hover" href="@url.to('@system/extensions/index')">
    ...
    <li class="uk-width">
        <a class="uk-panel pk-system-hover" href="@url.to('@system/themes/index')">
    ...
    <li class="uk-width">
        <a class="uk-panel pk-system-hover" href="@url.to('@system/dashboard/settings')">
    ...
    <li class="uk-width">
        <a class="uk-panel pk-system-hover" href="@url.to('@system/system/storage')">
    ...
    <li class="uk-width">
        <a class="uk-panel pk-system-hover" href="@url.to('@system/update/index')">
    ...
    <li class="uk-width">
        <a class="uk-panel pk-system-hover" href="@url.to('@system/alias/index')">
    ...
    <li class="uk-width">
        <a class="uk-panel pk-system-hover" href="@url.to('@system/system/info')">
    ...
    <li class="uk-width">
        <a id="clearCache" class="uk-panel pk-system-hover" href="@url.to('@system/settings/clearcache')">
    ...
    <li class="uk-width">
        <a class="uk-panel pk-system-hover" href="@url.to('@system/marketplace/index')">
            <img src="@url.to('asset://system/images/icon-settings-marketplace.svg')" width="50" height="50" alt="@trans('Marketplace')">
...
<ul class="uk-grid pk-system" data-uk-grid-margin>
    ...
    <li class="uk-width">
        <a class="uk-panel pk-system-hover" href="@url.to('@system/extensions/settings', ['name' => extension.name])">
...
<div id="modal-clearcache" class="uk-modal">
    <div class="uk-modal-dialog">
        ...
        <form class="uk-form" action="@url.to('@system/system/clearcache')" method="post">
