...
<form class="uk-form uk-form-horizontal" action="@url.route('@system/settings/save')" method="post">
        ...
        <div class="uk-width-medium-3-4">
            ...
            <ul id="tab-content" class="uk-switcher uk-margin">
                ...
                <li>
                    ...
                    <div class="uk-form-row">
                        <div class="uk-form-controls">
                            <button type="button" class="uk-button" data-smtp data-smtp-test="@url.route('@system/settings/testsmtpconnection')">@trans('Check Connection')</button>
                            <button type="button" class="uk-button" data-mail-test="@url.route('@system/settings/testsendemail')">@trans('Send Test Email')</button>
                        </div>
                    </div>
