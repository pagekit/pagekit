    ...
    <body class="uk-height-1-1">
      ...
      <div class="tm-height-4-5 uk-vertical-align uk-text-center">
            <div class="uk-vertical-align-middle">
                ...
                <form class="js-login js-toggle uk-panel uk-panel-box tm-panel tm-panel-small uk-form" action="@url.to('@system/auth/authenticate')" method="post">
                ...
                <form class="uk-panel uk-panel-box uk-panel-box-primary tm-panel-login uk-form uk-hidden js-toggle" action="@url.to('@system/auth/reset')" method="post">
