        ...
        <div class="tm-navbar">
            <div class="uk-container uk-container-center">
            	...
            	<nav class="uk-navbar">
	                ...
	                <a class="uk-navbar-brand uk-hidden-small" href="@url.to('@system/system/admin')">
                        ...
                        <div class="uk-navbar-content" data-uk-dropdown>
                            ...
                            <div class="uk-dropdown uk-dropdown-small uk-dropdown-flip">
                                <ul class="uk-nav uk-nav-dropdown">
                                    ...
                                    <li><a href="@url.to('@system/user/edit', ['id' => user.id])">@trans('Settings')</a></li>
                                    <li><a href="@url.to('@system/auth/logout', ['redirect' => url.to('@system/system/admin', [], true)])">@trans('Logout')</a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <a class="uk-navbar-brand uk-navbar-center uk-visible-small" href="@url.to('@system/system/admin')">
                        <img src="@url.to('extension://system/assets/images/pagekit-logo.svg')" width="23" height="29" alt="@trans('Pagekit')">
                    </a>
