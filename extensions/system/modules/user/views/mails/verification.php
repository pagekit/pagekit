                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="600" id="panel-table">
                        <tr>
                            <td valign="top" align="center" style="font-size: 16px; line-height: 24px; font-family: Helvetica, Arial, sans-serif; color: #666;">
                                ...
                                <p style="margin: 20px 0; text-align: left;"><?= __('Thank you for signing up for %site%. Just one more step! Please click the button below to activate your account.', ['%site%' => '<strong style="color: #444">'.$app['module']['system']->config('site_title').'</strong>']) ?></p>

                                <p style="margin: 40px 0 0 0; text-align: center;">
                                    <a style="padding: 15px 20px; background: #37a5e4; border-radius: 3px; color: #fff; text-decoration: none;" href="<?= $app['url']->get('@system/registration/activate', ['user' => $user->getUsername(), 'key' => $user->getActivation()], true) ?>"><?= __('Activate Account') ?></a>
                                </p>
