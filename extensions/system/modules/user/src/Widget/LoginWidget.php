...
class LoginWidget implements TypeInterface
{
    ...
    public function render(WidgetInterface $widget, $options = [])
    {
        ...
        if ($user->isAuthenticated()) {
            ...
            return App::view('extensions/system/views/widgets/login/logout.razr', compact('widget', 'user', 'options', 'redirect'));
        }
        ...
        return App::view('extensions/system/views/widgets/login/login.razr', compact('widget', 'options', 'user', 'last_username', 'remember_me_param', 'redirect'));
    }
    ...
    {
        return App::view('extensions/system/views/widgets/login/edit.razr', compact('widget'));
    }
}
