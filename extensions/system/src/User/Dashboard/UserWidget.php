...
class UserWidget implements TypeInterface
{
    ...
    public function render(WidgetInterface $widget, $options = [])
    {
        ...
        return App::view('extensions/system/views/admin/dashboard/user/index.razr', compact('widget', 'users', 'options'));
    }
    ...
    {
        return App::view('extensions/system/views/admin/dashboard/user/edit.razr', compact('widget'));
    }
}
