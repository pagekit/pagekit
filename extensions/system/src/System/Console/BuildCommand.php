        ...
        $finder = Finder::create()
            ...
            ->filter(function ($file) {
                ...
                $exclude = [
                    ...
                    '^themes\/(?!(alpha)\/).*',
                    '^vendor\/composer\/composer\/(bin|doc|tests|porting|phpunit|composer\.lock)',
                    ...
                    '^vendor\/justinrainbow\/json-schema\/(bin|docs|tests|phpunit|composer\.lock)',
                    ...
                    '^vendor\/seld\/jsonlint\/(bin|tests|phpunit)',
