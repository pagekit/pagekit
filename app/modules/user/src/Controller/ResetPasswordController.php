...
{
    /**
     * @Response("app/modules/user/views/reset/request.php")
     */
        ...
        try {
            ...
            try {
                ...
                $mail->setTo($user->getEmail())
                     ...
                     ->setBody(App::tmpl('app/modules/user/views/mails/reset.php', compact('user', 'url', 'mail')), 'text/html')
                     ->send();
    ...
    /**
     * @Request({"user", "key"})
     * @Response("app/modules/user/views/reset/confirm.php")
     */
