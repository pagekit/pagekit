...
class UserWidget extends Type
{
    ...
    public function render(WidgetInterface $widget, $options = [])
    {
        ...
        return App::view('app/modules/user/views/dashboard/index.php', compact('widget', 'users', 'options'));
    }
    ...
    {
        return App::view('app/modules/user/views/dashboard/edit.php', compact('widget'));
    }
}
