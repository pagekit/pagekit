...
class LoginWidget implements TypeInterface
{
    ...
    public function render(WidgetInterface $widget, $options = [])
    {
        ...
        if ($user->isAuthenticated()) {
            ...
            return App::view('app/modules/user/views/login/logout.php', compact('widget', 'user', 'options', 'redirect'));
        }
        ...
        return App::view('app/modules/user/views/login/login.php', compact('widget', 'options', 'user', 'last_username', 'remember_me_param', 'redirect'));
    }
    ...
    {
        return App::view('app/modules/user/views/login/edit.php', compact('widget'));
    }
}
