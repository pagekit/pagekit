...
class SystemController extends Controller
{
    /**
     * @Access(admin=true)
     * @Response("app/modules/system/views/admin/settings/index.php")
     */
     ...
     * @Response("app/modules/system/views/admin/settings/storage.php")
     */
    ...
    /**
     * @Access(admin=true)
     * @Response("app/modules/system/views/admin/settings/info.php")
     */
