<?php $view->script('extensions-upload', 'app/modules/system/app/upload.js', ['vue-system', 'uikit-upload']) ?>
<?php $view->script('extensions-index', 'app/modules/system/app/extensions.js', 'marketplace') ?>
