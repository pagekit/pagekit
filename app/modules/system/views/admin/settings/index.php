...
<?php $view->script('settings', 'app/modules/system/assets/js/settings/index.js', 'uikit') ?>
...
<ul class="uk-grid pk-system" data-uk-grid-margin>
    ...
    <li class="uk-width">
        <a class="uk-panel pk-panel-icon" href="<?= $view->url('@system/settings') ?>">
            <img src="<?= $view->url()->getStatic('app/modules/system/assets/images/icon-settings.svg') ?>" width="50" height="50" alt="<?= __('Settings') ?>">
            <p><?= __('Settings') ?></p>
        </a>
    </li>
    <?php endif ?>
    ...
    <li class="uk-width">
        <a class="uk-panel pk-panel-icon" href="<?= $view->url('@system/extensions') ?>">
            <img src="<?= $view->url()->getStatic('app/modules/system/assets/images/icon-extensions.svg') ?>" width="50" height="50" alt="<?= __('Extensions') ?>">
            <p><?= __('Extensions') ?></p>
        </a>
    </li>
    <?php endif ?>
    ...
    <li class="uk-width">
        <a class="uk-panel pk-panel-icon" href="<?= $view->url('@system/themes') ?>">
            <img src="<?= $view->url()->getStatic('app/modules/system/assets/images/icon-themes.svg') ?>" width="50" height="50" alt="<?= __('Themes') ?>">
            <p><?= __('Themes') ?></p>
        </a>
    </li>
    <?php endif ?>
    ...
    <li class="uk-width">
        <a class="uk-panel pk-panel-icon" href="<?= $view->url('@system/dashboard/settings') ?>">
            <img src="<?= $view->url()->getStatic('app/modules/system/assets/images/icon-dashboard.svg') ?>" width="50" height="50" alt="<?= __('Dashboard') ?>">
            <p><?= __('Dashboard') ?></p>
        </a>
    </li>
    ...
    <li class="uk-width">
        <a class="uk-panel pk-panel-icon" href="<?= $view->url('@system/system/storage') ?>">
            <img src="<?= $view->url()->getStatic('app/modules/system/assets/images/icon-storage.svg') ?>" width="50" height="50" alt="<?= __('Storage') ?>">
            <p><?= __('Storage') ?></p>
        </a>
    </li>
    <?php endif ?>
    ...
    <li class="uk-width">
        <a class="uk-panel pk-panel-icon" href="<?= $view->url('@system/update') ?>">
            <img src="<?= $view->url()->getStatic('app/modules/system/assets/images/icon-update.svg') ?>" width="50" height="50" alt="<?= __('Update') ?>">
            <p><?= __('Update') ?></p>
        </a>
    </li>
    <?php endif ?>
    ...
    <li class="uk-width">
        <a class="uk-panel pk-panel-icon" href="<?= $view->url('@system/system/info') ?>">
            <img src="<?= $view->url()->getStatic('app/modules/system/assets/images/icon-info.svg') ?>" width="50" height="50" alt="<?= __('Info') ?>">
            <p><?= __('Info') ?></p>
        </a>
    </li>
    ...
    <li class="uk-width">
        <a id="clearCache" class="uk-panel pk-panel-icon">
            <img src="<?= $view->url()->getStatic('app/modules/system/assets/images/icon-cache.svg') ?>" width="50" height="50" alt="<?= __('Clear Cache') ?>">
            <p><?= __('Clear Cache') ?></p>
        </a>
    </li>
...
<ul class="uk-grid pk-system" data-uk-grid-margin>
    ...
    <li class="uk-width">
        <a class="uk-panel pk-panel-icon" href="<?= $view->url('@system/extensions/settings', ['name' => $extension]) ?>">
            <img class="uk-img-preserve" src="<?= $view->url('app/modules/system/assets/images/placeholder-icon.svg') ?>" width="50" height="50" alt="<?= $package->getTitle() ?>">
