...
{
    /**
     * @Response("app/modules/system/modules/user/views/registration.php")
     */
    ...
    protected function sendWelcomeEmail($user)
    {
        try {
            ...
            $mail->setTo($user->getEmail())
                 ...
                 ->setBody(App::view('app/modules/system/modules/user/views/mails/welcome.php', compact('user', 'mail')), 'text/html')
                 ->send();
    ...
    protected function sendVerificationMail($user)
    {
        try {
            ...
            $mail->setTo($user->getEmail())
                 ...
                 ->setBody(App::view('app/modules/system/modules/user/views/mails/verification.php', compact('user', 'mail')), 'text/html')
                 ->send();
    ...
    protected function sendApproveMail($user)
    {
        try {
            ...
            $mail->setTo(App::option('system:mail.from.address'))
                 ...
                 ->setBody(App::view('app/modules/system/modules/user/views/mails/approve.php', compact('user', 'mail')), 'text/html')
                 ->send();
