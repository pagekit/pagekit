<?php $view->style('permission-index', 'app/modules/system/assets/css/user.css') ?>
<?php $view->script('permission-index', 'app/modules/system/modules/user/app/role.js', ['vue-system', 'uikit-sticky']) ?>
