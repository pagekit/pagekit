...
class MenuWidget implements TypeInterface
{
    ...
    public function render(WidgetInterface $widget, $options = [])
    {
        ...
        $layout = isset($options['layout']) ? $options['layout'] : 'app/modules/system/modules/menu/views/widgets/menu/nav.razr';
    ...
    {
        return App::view('app/modules/system/modules/menu/views/widgets/menu/edit.razr', compact('widget'));
    }
}
