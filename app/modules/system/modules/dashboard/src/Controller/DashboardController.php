...
class DashboardController extends Controller
{
    ...
    /**
     * @Response("app/modules/system/modules/dashboard/views/admin/index.php")
     */
    ...
    /**
     * @Response("app/modules/system/modules/dashboard/views/admin/settings.php")
     */
    ...
    /**
     * @Request({"type"})
     * @Response("app/modules/system/modules/dashboard/views/admin/edit.php")
     */
