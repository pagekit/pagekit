<div class="js-editor-image uk-overlay uk-overlay-hover uk-display-block">
    ...
    <div class="uk-placeholder uk-placeholder-large uk-text-center uk-vertical-align ${src ? 'uk-hidden' : ''}">
        <div class="uk-vertical-align-middle"><img data-js-no-parse src="<?= $view->url()->getStatic('app/modules/system/assets/images/placeholder-editor-image.svg') ?>" width="60" height="60" alt="<?= __('Placeholder Image') ?>"></div>
    </div>
