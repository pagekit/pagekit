<div class="js-editor-video uk-overlay uk-overlay-hover uk-display-block">
    ...
    <div class="uk-placeholder uk-placeholder-large uk-text-center uk-vertical-align ${src ? 'uk-hidden' : ''}">
        <div class="uk-vertical-align-middle"><img data-js-no-parse src="<?= $view->url()->getStatic('app/modules/system/assets/images/placeholder-editor-video.svg') ?>" width="60" height="60" alt="<?= __('Placeholder Video') ?>"></div>
    </div>
