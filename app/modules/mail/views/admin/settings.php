...
<script id="template-mail" type="x-template">
    ...
    <div class="uk-form-row">
        ...
        <div class="uk-form-controls">
            <input id="form-emailaddress" class="uk-form-width-large" type="text" v-model="option['mail'].from_address">
        </div>
    </div>
    <div class="uk-form-row">
        <label for="form-fromname" class="uk-form-label">{{ 'From Name' | trans }}</label>
        <div class="uk-form-controls">
            <input id="form-fromname" class="uk-form-width-large" type="text" v-model="option['mail'].from_name">
        </div>
    </div>
    <div class="uk-form-row">
        <label for="form-mailer" class="uk-form-label">{{ 'Mailer' | trans }}</label>
        <div class="uk-form-controls">
            <select id="form-mailer" class="uk-form-width-large" v-model="option['mail'].driver">
                <option value="mail">{{ 'PHP Mailer' | trans }}</option>
                <option value="smtp">{{ 'SMTP Mailer' | trans }}</option>
            </select>
        </div>
    </div>
    <div class="uk-form-row" v-show="'smtp' == option['mail'].driver">
        <div class="uk-form-row">
            <label for="form-smtpport" class="uk-form-label">{{ 'SMTP Port' | trans }}</label>
            <div class="uk-form-controls">
                <input id="form-smtpport" class="uk-form-width-large" type="text" v-model="option['mail'].port">
            </div>
        </div>
        <div class="uk-form-row">
            <label for="form-smtphost" class="uk-form-label">{{ 'SMTP Host' | trans }}</label>
            <div class="uk-form-controls">
                <input id="form-smtphost" class="uk-form-width-large" type="text" v-model="option['mail'].host">
            </div>
        </div>
        <div class="uk-form-row">
            <label for="form-smtpuser" class="uk-form-label">{{ 'SMTP User' | trans }}</label>
            <div class="uk-form-controls">
                <input id="form-smtpuser" class="uk-form-width-large" type="text" v-model="option['mail'].username">
            </div>
        </div>
        <div class="uk-form-row">
            ...
            <div class="uk-form-controls js-password">
                <div class="uk-form-password">
                    <input id="form-smtppassword" class="uk-form-width-large" type="password" v-model="option['mail'].password">
        ...
        <div class="uk-form-row">
            ...
            <div class="uk-form-controls">
                <select id="form-smtpencryption" class="uk-form-width-large" v-model="option['mail'].encryption">
    ...
    <div class="uk-form-row">
        <div class="uk-form-controls">
            <button v-show="'smtp' == option['mail'].driver" type="button" class="uk-button" v-on="click: test('smtp')">{{ 'Check Connection' | trans }}</button>
