<?php return array (
  ...
  'Prefix must start with a letter and can only contain alphanumeric characters (A-Z, 0-9) and underscore (_)' => 'De prefix moet beginnen met een letter en kan alleen alfanumerieke tekens (A-Z, 0-9) en een underscore (_) bevatten',
  'Close' => 'Sluiten',
