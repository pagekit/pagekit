<template>
    ...
    <div class="uk-form uk-form-horizontal">
        ...
        <div class="uk-form-row">
            ...
            <div class="uk-form-controls">
                <input-image class="uk-form-width-large" source="{{@ config.view.logo }}"></input-image>
            </div>
        </div>
        ...
        <div class="uk-form-row">
            ...
            <div class="uk-form-controls uk-form-width-large">
                <input-image class="uk-form-width-large" source="{{@ config.icons.favicon }}"></input-image>
            </div>
        </div>
        ...
        <div class="uk-form-row">
            ...
            <div class="uk-form-controls uk-form-width-large">
                <input-image class="uk-form-width-large" source="{{@ config.icons.appicon }}"></input-image>
            </div>
        </div>
