        ...
        <div class="pk-width-sidebar">
            ...
            <div class="uk-panel">
                ...
                <ul class="uk-nav uk-nav-side pk-nav-large" v-el:tab>
                    <li :class="{'uk-active': section.active}" v-repeat="section: sections | orderBy 'priority'"><a><i class="uk-icon-justify uk-icon-small uk-margin-right {{ section.icon }}"></i> {{ section.label | trans }}</a></li>
                </ul>
        ...
        <div class="uk-flex-item-1">
            ...
            <ul class="uk-switcher uk-margin" v-el:content>
                <li v-repeat="section: sections | orderBy 'priority'">
                    <component :is="section.name" :config.sync="config" :form.sync="form"></component>
                </li>
            </ul>
