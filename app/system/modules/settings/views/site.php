...
<div class="uk-form-row">
    ...
    <div class="uk-form-controls">
        <input id="form-title" class="uk-form-width-large" type="text" v-model="option.system.site.title">
    </div>
</div>
...
<div class="uk-form-row">
    ...
    <div class="uk-form-controls">
        <textarea id="form-description" class="uk-form-width-large" rows="5" v-model="option.system.site.description"></textarea>
    </div>
</div>
